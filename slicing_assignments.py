...
print(t[2][1]['names'][0][2],t[2][1]['names'][0][1],t[2][1]['names'][0][0],sep='')
...
"""
l3 = [1, 2, 3]
print(l3[1])          #using index we are getting the integer value
print(l3[1:2:])       #using slicing we are getting list value
